...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.form--search--close').click(function(e){
      ...
      $('.menu--mobile--toggle ._toggle').removeClass('search-open');
    });
    
    // menu mobile
    $( '.menu--mobile--toggle ._toggle' ).click(function()
    {
        $(this).toggleClass( 'open' );
        $( '.menu--mobile--main' ).toggleClass( 'open' );
        return false;
    });
    ...
    //slider arrow position height
    function arrowHeight() {
      var sliderHeight = $('.slick-slide img').height();
      $('.slider--arrow').css({
        height : sliderHeight
      });
     }
